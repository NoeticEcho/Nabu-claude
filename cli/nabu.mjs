...
const ALLOWED_TOOLS = "mcp__nabu-memory,mcp__nabu-pipeline,mcp__nabu-council,mcp__nabu-domain,mcp__nabu-analytics,mcp__nabu-improve,mcp__nabu-voice,mcp__nabu-connect,Read,Glob,Grep,Task";
