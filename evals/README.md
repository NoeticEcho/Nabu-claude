...
Требование: `docs/09` §12 (eval-проводка) и `docs/10` (test strategy); проверяемые инварианты —
`SAFETY.md`, `docs/28_wellbeing_safety.md`, `agents/critic.md`.
...
## Baselines и правило CI (docs/09 §12)
